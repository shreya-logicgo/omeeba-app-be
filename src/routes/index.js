...
import appleWebhookRoutes from "./apple-webhook.routes.js";
import googleWebhookRoutes from "./google-webhook.routes.js";
...
router.use(`/${config.apiVersion}/apple`, appleWebhookRoutes);
router.use(`/${config.apiVersion}/google`, googleWebhookRoutes);
